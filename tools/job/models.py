...
# discovered raw job plus all generated output files exist on disk.
...
class JobState:
    ...
    def is_done(self) -> bool:
        return (
            ...
            and self.notes_file.exists()
            and self.summary_file.exists()
            and self.skills_file.exists()
            and self.cv_file.exists()
        )
